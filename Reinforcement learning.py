...
while(True):
    ...
    model.learn(total_timesteps=TIMESTEPS,
                reset_num_timesteps=False, tb_log_name="SAC_default")
...
while(True):
    ...
    gate, finish = airsim_env.Circuit1.cycle_tick(
...
model = SAC.load("C:/Users/jamyl/Documents/GitHub/AirSim-GYM-environment/Training/32800",
...
while(True):
    model.learn(total_timesteps=1000,
                reset_num_timesteps=False, tb_log_name="SAC_1")
